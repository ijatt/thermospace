...
$profitQuery = "SELECT SUM(price) as total_price from reservation";
		...
		<div class="sidebar" id="sidebar">
			<div class="sidebar-inner slimscroll">
				<div id="sidebar-menu" class="sidebar-menu">
					<ul>
						<li class="active"> <a href="homepage.php"><i class="fas fa-tachometer-alt"></i> <span>Dashboard</span></a> </li>
				...
				<div class="page-header">
					<div class="row">
						<div class="col-sm-12 mt-5">
							<h3 class="page-title mt-3">Hello <?php echo $staffData['staffName']; ?>!</h3>
							<ul class="breadcrumb">
						...
						<div class="card board1 fill">
							<div class="card-body">
								<div class="dash-widget-header">
									<div>
										<h3 class="card_widget_header"><?php echo $reservecount ?></h3>
					...
					<div class="col-xl-3 col-sm-6 col-12">
						<div class="card board1 fill">
							<div class="card-body">
								<div class="dash-widget-header">
									<div>
										<h3 class="card_widget_header"><?php echo $roomcount ?></h3>
									...
									<div class="ml-auto mt-md-3 mt-lg-0">
										<span class="opacity-7 text-muted">
											<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#009688" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-home">
												<path d="M3 9.5l9-7 9 7v8a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2zM9 22V12h6v10"></path>
											</svg>
										</span>
									</div>
								</div>
					...
					<div class="col-xl-3 col-sm-6 col-12">
						<div class="card board1 fill">
							<div class="card-body">
								<div class="dash-widget-header">
									<div>
										<h3 class="card_widget_header">RM <?php echo $profitData['total_price'] ?></h3>
									...
									<table class="table table-hover table-center">
										...
										<tbody>
											...
											while($row = mysqli_fetch_assoc($reserveResult)) {
												...
												echo '<td class="text-right">'.$row['phone'].'</td>';
												echo '<td class="text-right">'.$row['checkIn'].'</td>';
												echo '<td class="text-right">'.$row['checkOut'].'</td>';
												echo '<td class="text-right"><span class="badge badge-pill bg-success inv-badge">'.$reservationStatus.'</span></td>';
												echo '</tr>';
											}
											?>
										</tbody>
