			...
			<ul class="nav user-menu">
				<li class="nav-item dropdown has-arrow">
					<a href="#" class="dropdown-toggle nav-link" data-toggle="dropdown"> <span class="user-img"><img
								...
								alt="profile-pic" style="object-fit: cover;"></span> </a>
					<div class="dropdown-menu">
						<div class="user-header">
							<div class="avatar avatar-sm"> <img src="<?php echo $staffData['imgURL']; ?> "
									alt="User Image" class="avatar-img rounded-circle" style="width: 38px !important; height: 38px !important; object-fit: cover;"> </div>
							<div class="user-text">
								<h6>
		...
		<div class="sidebar" id="sidebar">
			<div class="sidebar-inner slimscroll">
				<div id="sidebar-menu" class="sidebar-menu">
					<ul>
						<li> <a href="homepage.php"><i class="fas fa-tachometer-alt"></i>
						...
						<li class="submenu"> <a href="#"><i class="fas fa-key"></i> <span> Rooms </span> <span
							...
							<ul class="submenu_class" style="display: none;">
								...
								<li><a class="active" href="add-room.php"> Add Rooms </a></li>
							</ul>
						</li>
							...
							<div class="row formtype">
								...
								<div class="col-md-4">
									<div class="form-group">
										...
										<input class="form-control" type="text" name="roomBed" />
									</div>
								</div>
								<div class="col-md-4">
									<div class="form-group">
										<label>Room Bath</label>
										<input class="form-control" type="text" name="roomBath" />
									</div>
								</div>
								<div class="col-md-4">
									<div class="form-group">
										<label>Room Wifi</label>
										<input class="form-control" type="text" name="roomWifi" />
									</div>
								</div>
								<div class="col-md-4">
									<div class="form-group">
										<label>Room TV</label>
										<input class="form-control" type="text" name="roomTv" />
									</div>
								</div>
								<div class="col-md-4">
									<div class="form-group">
										<label>Room Price</label>
										<input class="form-control" type="text" name="roomPrice" />
									</div>
								</div>
								<div class="col-md-4">
									<div class="form-group">
										<label>Room Desc</label>
										<textarea class="form-control" rows="5" id="comment" name="roomDesc"></textarea>
									</div>
								</div>
								<div class="col-md-4">
									<div class="form-group">
										...
										<img src="assets/img/default.jpg" alt="" id="roomimg" style="width: 150px; height: 150px; border: solid 1px;">
									</div>
								</div>
							</div>
