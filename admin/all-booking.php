...
$reserveQuery = "SELECT reservation.*, customers.*, rooms.* FROM reservation INNER JOIN customers ON reservation.customerID = customers.customerID INNER JOIN rooms ON reservation.roomID = rooms.roomID ORDER BY checkOut desc";
$reserveResult = mysqli_query($conn, $reserveQuery);
$reservecount = mysqli_num_rows($reserveResult);
...
<body>
        ...
        <div class="header">
            <div class="header-left">
                <a href="index.html" class="logo"> <img src="assets/img/hotel_logo.png" width="50" height="70"
                        alt="logo"> <span class="logoclass">Thermospace</span> </a>
            ...
            <ul class="nav user-menu">
                <li class="nav-item dropdown has-arrow">
                    <a href="#" class="dropdown-toggle nav-link" data-toggle="dropdown"> <span class="user-img"><img
                                class="rounded-circle" src="<?php echo $staffData['imgURL']; ?>" width="40" height="40"
                    ...
                    <ul>
                        ...
                        <li class="submenu"> <a href="#"><i class="fas fa-suitcase"></i> <span> Booking </span> <span
                            ...
                            <ul class="submenu_class" style="display: none;">
                                <li><a class="active" href="all-booking.php"> All Booking </a></li>
                            ...
                            <div class="card-body booking_card">
                                <div class="table-responsive">
                                    <table class="datatable table table-stripped table table-hover table-center mb-0">
                                        ...
                                        <tbody>
                                            <?php
											while($row = mysqli_fetch_assoc($reserveResult)){
												...
												} elseif ($currentDate >= $checkInDate && $currentDate <= $checkOutDate) {
													$reservationStatus = 'Active';
												} else {
													$reservationStatus = 'Booked';
												}
												echo '<tr>';
												echo '<td class="text-center">'.$row['reserveID'].'</td>';
												echo '<td>
														<h2 class="table-avatar">
														<a class="avatar avatar-sm mr-2"><img style="width: 38px !important; height="38px !important;" class="avatar-img rounded-circle" src="'.$imgURL.'" alt="User Image"></a>
												...
												echo '<td class="text-right"><div class="actions"> <a href="#" class="btn btn-sm bg-success-light mr-2">'.$reservationStatus.'</a> </div></td>';
												echo '<td class="text-right">
														<div class="dropdown dropdown-action"> <a href="#" class="action-icon dropdown-toggle" data-toggle="dropdown" aria-expanded="false"><i class="fas fa-ellipsis-v ellipse_color"></i></a>
															<div class="dropdown-menu dropdown-menu-right"> <a class="dropdown-item" href="edit-booking.php?reservationID='.$row['reserveID'].'&checkIn='.$row['checkIn'].'&checkOut='.$row['checkOut'].'"><i class="fas fa-pencil-alt m-r-5"></i> Edit</a> <a class="dropdown-item" href="#" data-toggle="modal" data-target="#delete_asset" data-reserveID="'.$row['reserveID'].'"><i class="fas fa-trash-alt m-r-5"></i> Delete</a> </div>
														</div>
													  </td>';
												echo '</tr>';
											}
    ...
    $(document).ready(function() {
        $('#delete_asset').on('show.bs.modal', function(e) {
            ...
            var reserveID = button.data('reserveid');
            console.log(reserveID);

            var deleteURL = 'delete-booking.php?reserveID=' + reserveID;
